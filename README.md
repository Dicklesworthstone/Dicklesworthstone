...
![Stars: 32,060+](https://img.shields.io/static/v1?label=Stars&message=32%2C060%2B&color=2b2b2b&style=flat-square&logo=github&logoColor=white)
...
![Contributions: 287,669](https://img.shields.io/static/v1?label=Contributions+%281yr%29&message=287%2C669&color=2b2b2b&style=flat-square&logo=github&logoColor=white)
...
> [!NOTE]
> **287,669 contributions in the past year.** I use 63 AI coding agent subscription accounts (~$13.5K/month) and the Flywheel tools below. Most of those contributions landed after January 2026.

---

## The Agentic Coding Flywheel

Fourteen tools for multi-agent software development: messaging and file leases, issue graphs, session search, command safety, and tmux orchestration. I started building the stack in October 2025. Join the [Flywheel Hub Discord](https://discord.gg/gnCHsYDR25) (~946 members), read the [full guide](https://agent-flywheel.com/complete-guide), or start with the [introductory guide](https://agent-flywheel.com/core-flywheel).
...
|:--------|:-----:|:-------------|
| [**FrankenOCR**](https://github.com/Dicklesworthstone/franken_ocr) | ![Stars](https://img.shields.io/badge/stars-327-blue?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Ffranken_ocr) | Baidu Unlimited-OCR (3B MoE VLM) on CPU in pure Rust. Five supported models, custom int8 kernels, no Python. |
...
| [**FrankenTUI**](https://github.com/Dicklesworthstone/frankentui) | ![Stars](https://img.shields.io/badge/stars-280-blue?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Ffrankentui) | Terminal UI rendering in Rust across 20 crates, with 80+ widget and stateful-widget implementations. |
| [**FrankenTerm**](https://github.com/Dicklesworthstone/frankenterm) | ![Stars](https://img.shields.io/badge/stars-118-blue?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Ffrankenterm) | WezTerm fork with pane capture, state-machine detection, and a JSON control API for AI-agent swarms. |
...
| [**FrankenSearch**](https://github.com/Dicklesworthstone/frankensearch) | ![Stars](https://img.shields.io/badge/stars-85-blue?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Ffrankensearch) | Two-tier hybrid search: HNSW ANN + Tantivy full-text + cross-encoder reranking. |
...
| [**FrankenNumPy**](https://github.com/Dicklesworthstone/franken_numpy) | ![Stars](https://img.shields.io/badge/stars-18-blue?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Ffranken_numpy) | NumPy in Rust. 10 crates, 8,100+ tests, bit-exact RNG parity. Unsafe forbidden outside the PyO3 binding layer. |
...
| | Project | Description |
|:--|:--|:--|
| ![Stars](https://img.shields.io/badge/stars-3,001-2b2b2b?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Fllm_aided_ocr) | **[LLM-Aided OCR](https://github.com/Dicklesworthstone/llm_aided_ocr)** | Uses language models to correct OCR errors that rule-based postprocessing misses. |
...
| ![Stars](https://img.shields.io/badge/stars-280-2b2b2b?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Ffrankentui) | **[FrankenTUI](https://github.com/Dicklesworthstone/frankentui)** | Terminal UI rendering kernel used by CASS and other Rust TUI applications. |
...
| ![Stars](https://img.shields.io/badge/stars-118-2b2b2b?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Ffrankenterm) | **[FrankenTerm](https://github.com/Dicklesworthstone/frankenterm)** | WezTerm fork with pane capture, state-machine detection, and a JSON control API for AI-agent swarms. |
| ![Stars](https://img.shields.io/badge/stars-278-2b2b2b?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Fasupersync) | **[Asupersync](https://github.com/Dicklesworthstone/asupersync)** | Structured concurrency runtime with regions, cancel-correct protocols, and capability-scoped context. Foundation for Pi Agent Rust and FastMCP Rust. |
...
| ![Stars](https://img.shields.io/badge/stars-86-2b2b2b?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Fflywheel_connectors) | **[Flywheel Connectors](https://github.com/Dicklesworthstone/flywheel_connectors)** | 176 connectors (~2.5M lines Rust, 72K+ tests). WASI sandboxing, cryptographic capability tokens, zone-based encryption. |
| ![Stars](https://img.shields.io/badge/stars-1,750-2b2b2b?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Fpi_agent_rust) | **[Pi Agent Rust](https://github.com/Dicklesworthstone/pi_agent_rust)** | AI coding agent CLI in Rust. Sub-100ms startup, 8 built-in tools, session branching, ~15MB binary. |
| ![Stars](https://img.shields.io/badge/stars-169-2b2b2b?style=flat-square&logo=github&logoColor=white&repo=Dicklesworthstone%2Fmcp_agent_mail_rust) | **[MCP Agent Mail Rust](https://github.com/Dicklesworthstone/mcp_agent_mail_rust)** | Ground-up Rust rewrite of Agent Mail. 12-crate workspace, 37 MCP tools, optional FrankenSearch hybrid search. |
...
| **[Agent-Flywheel.com](https://agent-flywheel.com)** | Flywheel documentation, setup guides, and the [Flywheel Hub Discord](https://discord.gg/gnCHsYDR25) (~946 members). |
...
- 32,060+ GitHub stars, 3,300+ GitHub followers, 205 open-source projects, 48.7K X followers
